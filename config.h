...
char *colors[][2] = {
	...
	[SchemeSel]  = { "#eeeeee", "#beaa9b" },
	[SchemeOut]  = { "#000000", "#00ffff" },
	#if BORDER_PATCH
	[SchemeBorder] = { "#000000", "#beaa9b" },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
	[SchemeMid]  = { "#eeeeee", "#770000" },
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#ffc978", "#beaa9b" },
	...
	#endif // HIGHPRIORITY_PATCH
	#if EMOJI_HIGHLIGHT_PATCH
	[SchemeHover]  = { "#beaa9b", "#353D4B" },
	[SchemeGreen]  = { "#beaa9b", "#52E067" },
	[SchemeRed]    = { "#beaa9b", "#e05252" },
	[SchemeYellow] = { "#beaa9b", "#e0c452" },
	[SchemeBlue]   = { "#beaa9b", "#5280e0" },
	[SchemePurple] = { "#beaa9b", "#9952e0" },
	#endif // EMOJI_HIGHLIGHT_PATCH
	#if VI_MODE_PATCH
